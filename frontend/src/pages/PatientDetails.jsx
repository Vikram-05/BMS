  ...
  <main className="mx-auto max-w-6xl px-4 sm:px-6 py-8 space-y-8">
    ...
    <section className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 sm:p-8 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.6)]">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h1 className=" translate-y-1.5 text-3xl sm:text-4xl tracking-tight font-semibold text-white">Rohit Sharma</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-neutral-200">XXXX-XXXX-1234</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-neutral-200">Male <span className="mx-2 text-neutral-500">•</span> 38</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-neutral-200">B+</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-neutral-200">+91 98765 43210</p>
              <p className="text-xs text-neutral-400">rohit.sharma@example.com</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
      <div className="flex items-end justify-between mb-4">
        ...
        <div className="text-sm text-neutral-400"><span id="resultsCount">4</span> results</div>
      </div>

      <div id="cardsGrid" className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5">
      {/* -----------DIAGNOSIS-HISTORY-CARD----------------- */}
        <article data-status="verified" data-title="Hypertension" data-doctor="Dr. A. Menon" data-date="2025-08-21" className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-[18px] sm:text-lg font-semibold tracking-tight text-white">Hypertension</h3>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <a href="#" className="inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-neutral-200 bg-white/5 hover:bg-white/10 border border-white/10 transition">
        ...
        <article data-status="verified" data-title="Type 2 Diabetes" data-doctor="Dr. K. Rao" data-date="2025-05-10" className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-[18px] sm:text-lg font-semibold tracking-tight text-white">Type 2 Diabetes</h3>
        ...
        <article data-status="pending" data-title="Acute Bronchitis" data-doctor="Dr. S. Patel" data-date="2024-12-03" className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="h-11 w-11 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center">
              {icons[Math.floor((Math.random()*5))]}
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-[18px] sm:text-lg font-semibold tracking-tight text-white">Acute Bronchitis</h3>
        ...
        <article data-status="verified" data-title="Migraine" data-doctor="Dr. L. Kapoor" data-date="2024-09-15" className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-cyan-400/30 to-emerald-400/30 border border-white/10 flex items-center justify-center">
              {icons[Math.floor((Math.random()*5))]}
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  <h3 className="text-[18px] sm:text-lg font-semibold tracking-tight text-white">Migraine</h3>
