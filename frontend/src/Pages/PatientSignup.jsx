                        ...
                        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-6 shadow-[0_0_0_1px_rgba(2,6,23,0.8),0_10px_40px_-10px_rgba(34,211,238,0.18)] backdrop-blur">
                            ...
                            <form id="signupForm" novalidate className="space-y-5 ">
                                ...
                                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    <div className="group">
                                        <label for="age" className="mb-2 block text-sm text-slate-300">Age</label>
                                        <div className="relative">
                                            <div className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
                                                <i data-lucide="hash" className="h-4 w-4"></i>
                                            </div>
                                            <input id="age" name="age" inputmode="numeric" placeholder="e.g., 32"
                                                className="w-full rounded-xl border border-slate-800 bg-slate-950/60 px-10 py-3 text-slate-100 placeholder-slate-500 outline-none transition-all focus:border-cyan-400/60 focus:ring-4 focus:ring-cyan-500/15" />
                                            <div className="absolute right-3 top-1/2 -translate-y-1/2">
                                                <i data-lucide="check-circle-2" className="h-5 w-5 text-emerald-400 opacity-0 transition-opacity" id="age-valid"></i>
                                                <i data-lucide="alert-circle" className="h-5 w-5 text-rose-400 opacity-0 transition-opacity" id="age-invalid"></i>
                                            </div>
                                        </div>
                                        <p className="mt-1 hidden text-sm text-rose-400" id="age-error">Enter a valid age (0–120).</p>
                                    </div>

                                    <div className="group">
                                        <label for="bloodGroup" className="mb-2 block text-sm text-slate-300">Blood Group</label>
                                        <div className="relative">
                                            <div className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400">
                                            ...
                                            <div className="absolute right-8 top-1/2 -translate-y-1/2">
                                                <i data-lucide="check-circle-2" className="h-5 w-5 text-emerald-400 opacity-0 transition-opacity" id="bg-valid"></i>
                                                <i data-lucide="alert-circle" className="h-5 w-5 text-rose-400 opacity-0 transition-opacity" id="bg-invalid"></i>
                                            </div>
                                        </div>
                                        <p className="mt-1 hidden text-sm text-rose-400" id="bg-error">Please select your blood group.</p>
                                    </div>
                                </div>
                                ...
                                <div className="group">
                                    ...
                                    <p className="mt-1 hidden text-sm text-rose-400" id="gender-error">Please select your gender.</p>
                                </div>
